...
<div class="row"> 
  <div class="col-md-8 col-md-offset-2">
   ...
   <div class="alert alert-success" role="alert"> ادخال النتيجة : </div>
</div>
 
	 <div class="col-md-8 col-md-offset-2">
		{!! Form::open(['route' => 'result.selectResult', 'data-parsley-validate' => '','method'=>'POST','enctype'=>'multipart/form-data' ]) !!}
         {{csrf_field()}}
         {{ method_field('get') }}
